...
for station in stations:
  ...
  cluster_1 = [[station,fields[0]]]

  X_train,y_train = data_prep.get_train_data(folder,cluster_1,seasonal_removal,seq_length,horizon)
  X_test, y_test, v_recover = data_prep.get_test_data(folder,[station],seasonal_removal,seq_length,horizon)
